...
os.makedirs('/content/drive/MyDrive/volatile-concentration-localux/static', exist_ok=True)
timerscriptdir = '/content/drive/MyDrive/volatile-concentration-localux/extensions-builtin/nocrypt-colab-timer/javascript'
